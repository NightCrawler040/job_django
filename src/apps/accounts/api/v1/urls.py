...
from src.apps.accounts.api.v1.views.login import LoginView, LogoutView
from src.apps.accounts.api.v1.views.password import (
    ChangePasswordAPIView,
    ConfirmResetPasswordAPIView,
    ResetPasswordAPIView,
)
from src.apps.accounts.api.v1.views.registration import RegistrationAPIView
from src.apps.accounts.api.v1.views.user_profile import UserProfileAPIView
